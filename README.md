...
The field GF(2<sup>8</sup>) is a finite field containing 2<sup>8</sup> elements, also known as the Galois field. This field is the ring of integers 2<sup>8</sup> long. Within this ring you can perform the operations of addition, subtraction and multiplication but you must follow them with a modulus of 2<sup>8</sup>, i.e. if you move beyond the ring you start again at the begining. 
